...
alternate least-square method. It means that you can implement a
recommendation system with a few lines of code only.

The example below, extracted from the Spark documentation, loads a
sample of the MovieLens dataset, parses it as
\href{http://spark.apache.org/docs/latest/api/python/pyspark.sql.html#pyspark.sql.Row}{DataFrame
  Rows} and create a DataFrame from these Rows:
\begin{cli}
