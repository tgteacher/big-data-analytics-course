...
{\footnotesize\lstset{columns=fullflexible,language=bash,backgroundcolor=\color{mygray}}}
{}

\lstnewenvironment{xml}
{\footnotesize\lstset{columns=fullflexible,language=xml,backgroundcolor=\color{Salmon}}}
{}
...
\newcommand{\javacode}[1]{
  \footnotesize
  \par
  \hfill \colorbox{YellowGreen}{\href{https://github.com/glatard/big-data-analytics-labs/blob/master/#1}{(\underline{Link to file})}} \hfill
  \vspace*{-0.3cm}
  \lstset{language=java,columns=fullflexible,backgroundcolor=\color{YellowGreen}}
  \lstinputlisting{#1}
}
